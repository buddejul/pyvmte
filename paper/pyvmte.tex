...
\textbf{Notes}: This figure compares simulation results for the main specification described in Section \ref{sec:4_sim} for different tolerances levels $\kappa_n$.}
...
\textbf{Notes}: This figure compares simulation results for the main specification described in Section \ref{sec:4_sim} different samples sizes $N$.}
